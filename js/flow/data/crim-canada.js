define(['jquery'], function($) {
	...
	return {
		...
		condition: function(q1, q2a, q2b, q4, q5a, q5b, q6, q7, q8, q9, q10, q11, q12) {
			...
			var scenario1RelevantAbusers = ["Soldier in government's army", 'Police officer', 'Other government official', 'Soldier in rebel army', 'None of the above'];
			...
			proceed = false;
			if((q1.isNotAnswered() || q1.hasCountry(relevantCountries)) || (q2b.isAvailable() && q2b.hasCountry(relevantCountries))) {
				proceed = true;
			}
