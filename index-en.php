<?php
    //	supporting temporary authentication requirement during testing / refinement. Final product will not require authentication
...
<html lang="en">
	...
	<link href="css/src/ccij.css?flow-v=0.8.1" rel="stylesheet" type="text/css" />
	<link href="css/print.css?flow-v=0.8.1" rel="stylesheet" type="text/css" media="print" />
	...
	<script type="text/javascript">
	    var requirejs = {urlArgs: 'flow-v=0.8.1'};
