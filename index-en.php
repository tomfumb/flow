        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-24 col-sm-24 col-md-17 col-lg-17">
                    <h1 class="wise-logo wise-logo-en">Canadian Centre for International Justice</h1>
				...
				<!-- End W&H header -->
					<div id="ccij_main">
						...
						<div id="flow_restart_confirm" title="Confirm restart">
                            ...
                            <div id="flow_restart_yes" class="hidden">Yes</div>
                            <div id="flow_restart_no" class="hidden">No</div>
						</div>
					</div>
					<div id="flow_print">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-8">
					...
					<p>
						<a href="https://www.gifttool.com/donations/Donate?ID=1564&AID=574" class="btn btn-primary btn-lg" id="ccij_donate">Donate Now</a>
					</p>
				</div>
				<div class="col-sm-8">
