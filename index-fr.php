...
<html lang="en">
	...
	<link href="css/dist/ccij-flow.css?flow-v=0.9.25" rel="stylesheet" type="text/css" />
	<link href="css/print.css?flow-v=0.9.25" rel="stylesheet" type="text/css" media="print" />
	...
	<script type="text/javascript">
	    var requirejs = {urlArgs: 'flow-v=0.9.25'};
